...
from .admin_list_attempts_route import router as admin_list_attempts_router
...
from .reset_attempts_route import router as reset_attempts_router
...
attempts_router.include_router(admin_list_attempts_router)
attempts_router.include_router(submit_attempt_router)
attempts_router.include_router(reset_attempts_router)
